...
class ComputeRuntime:
    ...
    def build_compute_runtime(self, gmmlib, level_zero):
        self.compute_runtime_repo = git_clone(options.workdir, "compute-runtime-repo", "https://github.com/intel/compute-runtime.git", "fde9a0bf57be3d727ea6f7584f80cf50b64ed72d")
        ...
        # specyfing custom L0 is problematic...
        ...
        # Remove -Werror...
        replace_in_file(cmakelists_path, r'-Werror', '')
