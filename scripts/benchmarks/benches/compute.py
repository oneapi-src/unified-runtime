...
class ComputeBench(Suite):
    ...
    def benchmarks(self) -> list[Benchmark]:
        ...
        benches = [
            ...
            GraphApiSinKernelSYCL(self, 0, 50),
            GraphApiSinKernelSYCL(self, 1, 50),
            ...
            GraphApiSubmitExecute(self, 0, 0, 20),
            GraphApiSubmitExecute(self, 0, 1, 20),
            GraphApiSubmitExecute(self, 1, 0, 20),
            GraphApiSubmitExecute(self, 1, 1, 20),
