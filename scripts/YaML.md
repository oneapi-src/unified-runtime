...
* A macro may take the following optional fields which can be scalars, a sequence of scalars or scalars to sequences: {`details`}
...
* A typedef may take the following optional fields which can be scalars, a sequence of scalars or scalars to sequences: {`details`}
...
* A handle may take the following optional fields which can be scalars, a sequence of scalars or scalars to sequences: {`details`}
...
* An enum may take the following optional fields which can be scalars, a sequence of scalars or scalars to sequences: {`details`}
...
* A struct|union may take the following optional fields which can be scalars, a sequence of scalars or scalars to sequences: {`details`}
...
* A function may take the following optional fields which can be scalars, a sequence of scalars or scalars to sequences: {`details`}
...
* A class may take the following optional fields which can be scalars, a sequence of scalars or scalars to sequences: {`details`}
