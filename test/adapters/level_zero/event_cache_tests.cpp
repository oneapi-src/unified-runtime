...
UUR_TEST_SUITE_P(urEventCacheTest,
                 ::testing::
                     Combine(testing::Values(0, UR_QUEUE_FLAG_DISCARD_EVENTS),
                             testing::Values(
                                 0,
                                 UR_QUEUE_FLAG_OUT_OF_ORDER_EXEC_MODE_ENABLE),
                             // TODO: why the test fails with
                             // UR_QUEUE_FLAG_SUBMISSION_BATCHED?
                             testing::Values(UR_QUEUE_FLAG_SUBMISSION_IMMEDIATE /*, UR_QUEUE_FLAG_SUBMISSION_BATCHED */),
                             testing::Values(0,
