...
TEST_P(urL0EnqueueAllocTest, SuccessDevice) {
    ...
    ASSERT_SUCCESS(urEnqueueUSMDeviceAllocExp(
        queue, nullptr, ARRAY_SIZE * sizeof(uint32_t), nullptr, 0, nullptr,
        &ptr, &allocEvent));
    ASSERT_NE(ptr, nullptr);
    ASSERT_NE(allocEvent, nullptr);
...
TEST_P(urL0EnqueueAllocTest, SuccessDeviceRepeat) {
    ...
    Launch1DRange(ARRAY_SIZE);
    ASSERT_SUCCESS(
        urEnqueueUSMFreeExp(queue, nullptr, ptr, 0, nullptr, nullptr));
...
TEST_P(urL0EnqueueAllocTest, SuccessShared) {
    ...
    void *ptr = nullptr;
    ur_event_handle_t allocEvent = nullptr;
    ASSERT_SUCCESS(urEnqueueUSMSharedAllocExp(
        queue, nullptr, ARRAY_SIZE * sizeof(uint32_t), nullptr, 0, nullptr,
        &ptr, &allocEvent));
    ASSERT_NE(ptr, nullptr);
    ASSERT_NE(allocEvent, nullptr);
