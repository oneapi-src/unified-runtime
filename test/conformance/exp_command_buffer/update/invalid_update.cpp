...
struct urInvalidUpdateCommandBufferExpExecutionTest
...
UUR_INSTANTIATE_DEVICE_TEST_SUITE_P(
    urInvalidUpdateCommandBufferExpExecutionTest);

// Test error reported if device doesn't support updating kernel args
TEST_P(urInvalidUpdateCommandBufferExpExecutionTest, KernelArg) {
...
TEST_P(urInvalidUpdateCommandBufferExpExecutionTest, GlobalSize) {
    if (update_capability_flags &
...
TEST_P(urInvalidUpdateCommandBufferExpExecutionTest, GlobalOffset) {
    if (update_capability_flags &
...
TEST_P(urInvalidUpdateCommandBufferExpExecutionTest, LocalSize) {
    if (update_capability_flags &
...
TEST_P(urInvalidUpdateCommandBufferExpExecutionTest, Kernel) {
    if (update_capability_flags &
