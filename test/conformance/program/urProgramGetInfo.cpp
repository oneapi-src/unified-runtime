...
struct urProgramGetInfoTest : uur::urProgramTest<ur_program_info_t> {
    void SetUp() override {
        UUR_RETURN_ON_FATAL_FAILURE(urProgramTest<ur_program_info_t>::SetUp());
...
UUR_TEST_SUITE_P(
    ...
    uur::deviceTestPrinter<ur_program_info_t>);
