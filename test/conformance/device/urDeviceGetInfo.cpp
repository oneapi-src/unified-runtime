...
#include <uur/fixtures.h>
    ...
    static std::unordered_map<ur_device_info_t, size_t>
        device_info_size_map = {
            ...
            {UR_DEVICE_INFO_SINGLE_FP_CONFIG,
             sizeof(ur_device_fp_capability_flags_t)},
            ...
            {UR_DEVICE_INFO_GLOBAL_MEM_CACHE_TYPE,
             sizeof(ur_device_mem_cache_type_t)},
