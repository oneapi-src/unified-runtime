...
ur_result_t UR_APICALL urAdapterRelease(
  ...
  auto pfnAdapterRelease = ur_lib::context->urDdiTable.Global.pfnAdapterRelease;
...
ur_result_t UR_APICALL urAdapterGetInfo(
    ...
    /// pPropValue.
    size_t *pPropSizeRet) try {
  auto pfnAdapterGetInfo = ur_lib::context->urDdiTable.Global.pfnAdapterGetInfo;
...
ur_result_t UR_APICALL urEnqueueWriteHostPipe(
    ...
    /// complete.
    ur_event_handle_t *phEvent) try {
  auto pfnWriteHostPipe = ur_lib::context->urDdiTable.Enqueue.pfnWriteHostPipe;
...
ur_result_t UR_APICALL urBindlessImagesUnsampledImageHandleDestroyExp(
    ...
    ur_exp_image_handle_t hImage) try {
...
ur_result_t UR_APICALL urBindlessImagesImageAllocateExp(
    ...
    ur_exp_image_mem_handle_t *phImageMem) try {
...
ur_result_t UR_APICALL urBindlessImagesImageFreeExp(
    ...
    ur_exp_image_mem_handle_t hImageMem) try {
...
ur_result_t UR_APICALL urBindlessImagesUnsampledImageCreateExp(
    ...
    const ur_image_desc_t *pImageDesc,
    /// [out] pointer to handle of image object created
    ur_exp_image_handle_t *phImage) try {
  auto pfnUnsampledImageCreateExp =
      ur_lib::context->urDdiTable.BindlessImagesExp.pfnUnsampledImageCreateExp;
...
ur_result_t UR_APICALL urBindlessImagesMipmapFreeExp(
    ...
    ur_device_handle_t hDevice,
    /// [in] handle of image memory to be freed
    ur_exp_image_mem_handle_t hMem) try {
...
ur_result_t UR_APICALL urBindlessImagesImportOpaqueFDExp(
    ...
    ur_exp_interop_mem_handle_t *phInteropMem) try {
...
ur_result_t UR_APICALL urBindlessImagesReleaseInteropExp(
    ...
    ur_exp_interop_mem_handle_t hInteropMem) try {
...
ur_result_t UR_APICALL urBindlessImagesImportExternalSemaphoreOpaqueFDExp(
    ...
    ur_exp_interop_semaphore_handle_t *phInteropSemaphore) try {
...
ur_result_t UR_APICALL urBindlessImagesDestroyExternalSemaphoreExp(
    ...
    ur_exp_interop_semaphore_handle_t hInteropSemaphore) try {
...
ur_result_t UR_APICALL urBindlessImagesWaitExternalSemaphoreExp(
  ...
  auto pfnWaitExternalSemaphoreExp =
      ur_lib::context->urDdiTable.BindlessImagesExp.pfnWaitExternalSemaphoreExp;
...
ur_result_t UR_APICALL urBindlessImagesSignalExternalSemaphoreExp(
  ...
  return pfnSignalExternalSemaphoreExp(hQueue, hSemaphore, numEventsInWaitList,
                                       phEventWaitList, phEvent);
} catch (...) {
  return exceptionToResult(std::current_exception());
}
...
ur_result_t UR_APICALL urCommandBufferCreateExp(
  ...
  auto pfnCreateExp = ur_lib::context->urDdiTable.CommandBufferExp.pfnCreateExp;
...
ur_result_t UR_APICALL urCommandBufferRetainExp(
  ...
  auto pfnRetainExp = ur_lib::context->urDdiTable.CommandBufferExp.pfnRetainExp;
...
ur_result_t UR_APICALL urCommandBufferAppendMemBufferCopyExp(
  ...
  return pfnAppendMemBufferCopyExp(hCommandBuffer, hSrcMem, hDstMem, srcOffset,
