...
__urdlllocal ur_result_t UR_APICALL urUSMHostAlloc(
  ...
  return context.interceptor->allocateMemory(hContext, nullptr, pUSMDesc, pool,
...
__urdlllocal ur_result_t UR_APICALL urEnqueueKernelLaunch(
  ...
  if (result == UR_RESULT_SUCCESS) {
    UR_CALL(context.interceptor->postLaunchKernel(hKernel, hQueue, LaunchInfo));
  }
...
ur_result_t context_t::init(ur_dditable_t *dditable,
  ...
  if (UR_RESULT_SUCCESS == result) {
    result = ur_sanitizer_layer::urGetMemProcAddrTable(UR_API_VERSION_CURRENT,
                                                       &dditable->Mem);
  }
  ...
  if (UR_RESULT_SUCCESS == result) {
    result = ur_sanitizer_layer::urGetUSMProcAddrTable(UR_API_VERSION_CURRENT,
                                                       &dditable->USM);
  }
