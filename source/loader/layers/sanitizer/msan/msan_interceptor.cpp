...
ur_result_t MsanInterceptor::allocateMemory(ur_context_handle_t Context,
    ...
    *ResultPtr = reinterpret_cast<void *>(Allocated);

    if (Type != AllocType::DEVICE_USM) {
        return UR_RESULT_SUCCESS;
    }

    uptr AllocBegin = (uptr)Allocated;
...
ur_result_t MsanInterceptor::enqueueAllocInfo(
...
ur_result_t
MsanInterceptor::registerDeviceGlobals(ur_context_handle_t Context,
