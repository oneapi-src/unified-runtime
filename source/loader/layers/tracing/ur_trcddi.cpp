...
__urdlllocal ur_result_t UR_APICALL urAdapterGet(
  ...
  context.notify_end(UR_FUNCTION_ADAPTER_GET, "urAdapterGet", &params, &result,
                     instance);
...
__urdlllocal ur_result_t UR_APICALL urAdapterGetLastError(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ADAPTER_GET_LAST_ERROR,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urAdapterGetInfo(
  ...
  context.notify_end(UR_FUNCTION_ADAPTER_GET_INFO, "urAdapterGetInfo", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urPlatformGet(
  ...
  uint64_t instance =
      context.notify_begin(UR_FUNCTION_PLATFORM_GET, "urPlatformGet", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_PLATFORM_GET, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urPlatformGetApiVersion(
  ...
  uint64_t instance = context.notify_begin(UR_FUNCTION_PLATFORM_GET_API_VERSION,
...
__urdlllocal ur_result_t UR_APICALL urPlatformGetBackendOption(
  ...
  context.notify_end(UR_FUNCTION_PLATFORM_GET_BACKEND_OPTION,
                     "urPlatformGetBackendOption", &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urDeviceRetain(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_DEVICE_RETAIN, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urDevicePartition(
  ...
  context.notify_end(UR_FUNCTION_DEVICE_PARTITION, "urDevicePartition", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urDeviceGetNativeHandle(
  ...
  uint64_t instance = context.notify_begin(UR_FUNCTION_DEVICE_GET_NATIVE_HANDLE,
...
__urdlllocal ur_result_t UR_APICALL urDeviceGetGlobalTimestamps(
  ...
  context.notify_end(UR_FUNCTION_DEVICE_GET_GLOBAL_TIMESTAMPS,
                     "urDeviceGetGlobalTimestamps", &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urContextGetInfo(
  ...
  context.notify_end(UR_FUNCTION_CONTEXT_GET_INFO, "urContextGetInfo", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urContextCreateWithNativeHandle(
    ...
    uint32_t numDevices,
    /// [in][range(0, numDevices)] list of devices associated with the context
    const ur_device_handle_t *phDevices,
...
__urdlllocal ur_result_t UR_APICALL urContextSetExtendedDeleter(
  ...
  context.notify_end(UR_FUNCTION_CONTEXT_SET_EXTENDED_DELETER,
                     "urContextSetExtendedDeleter", &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urMemImageCreate(
  ...
  context.notify_end(UR_FUNCTION_MEM_IMAGE_CREATE, "urMemImageCreate", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urMemRelease(
  ...
  context.notify_end(UR_FUNCTION_MEM_RELEASE, "urMemRelease", &params, &result,
                     instance);
...
__urdlllocal ur_result_t UR_APICALL urMemGetNativeHandle(
  ...
  context.notify_end(UR_FUNCTION_MEM_GET_NATIVE_HANDLE, "urMemGetNativeHandle",
                     &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urMemGetInfo(
  ...
  context.notify_end(UR_FUNCTION_MEM_GET_INFO, "urMemGetInfo", &params, &result,
                     instance);

  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_MEM_GET_INFO, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urSamplerGetInfo(
  ...
  context.notify_end(UR_FUNCTION_SAMPLER_GET_INFO, "urSamplerGetInfo", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urUSMDeviceAlloc(
  ...
  context.notify_end(UR_FUNCTION_USM_DEVICE_ALLOC, "urUSMDeviceAlloc", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urUSMSharedAlloc(
  ...
  context.notify_end(UR_FUNCTION_USM_SHARED_ALLOC, "urUSMSharedAlloc", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urUSMGetMemAllocInfo(
  ...
  context.notify_end(UR_FUNCTION_USM_GET_MEM_ALLOC_INFO, "urUSMGetMemAllocInfo",
                     &params, &result, instance);

  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_USM_GET_MEM_ALLOC_INFO,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urUSMPoolRelease(
  ...
  context.notify_end(UR_FUNCTION_USM_POOL_RELEASE, "urUSMPoolRelease", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urUSMPoolGetInfo(
  ...
  context.notify_end(UR_FUNCTION_USM_POOL_GET_INFO, "urUSMPoolGetInfo", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urVirtualMemFree(
  ...
  context.notify_end(UR_FUNCTION_VIRTUAL_MEM_FREE, "urVirtualMemFree", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urVirtualMemSetAccess(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_VIRTUAL_MEM_SET_ACCESS,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urPhysicalMemRetain(
    /// [in] handle of the physical memory object to retain.
    ur_physical_mem_handle_t hPhysicalMem) {
...
__urdlllocal ur_result_t UR_APICALL urPhysicalMemRelease(
    /// [in] handle of the physical memory object to release.
    ur_physical_mem_handle_t hPhysicalMem) {
...
__urdlllocal ur_result_t UR_APICALL urProgramCreateWithIL(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_PROGRAM_CREATE_WITH_IL,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urProgramCreateWithBinary(
    /// [in] handle of the context instance
    ur_context_handle_t hContext,
    /// [in] handle to device associated with binary.
    ur_device_handle_t hDevice,
    /// [in] size in bytes.
    size_t size,
    /// [in] pointer to binary.
...
__urdlllocal ur_result_t UR_APICALL urProgramBuild(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_PROGRAM_BUILD, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urProgramLink(
  ...
  ur_program_link_params_t params = {&hContext, &count, &phPrograms, &pOptions,
                                     &phProgram};
  uint64_t instance =
      context.notify_begin(UR_FUNCTION_PROGRAM_LINK, "urProgramLink", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_PROGRAM_LINK, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urProgramGetFunctionPointer(
  ...
  context.notify_end(UR_FUNCTION_PROGRAM_GET_FUNCTION_POINTER,
                     "urProgramGetFunctionPointer", &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urProgramGetInfo(
  ...
  context.notify_end(UR_FUNCTION_PROGRAM_GET_INFO, "urProgramGetInfo", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urProgramGetBuildInfo(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_PROGRAM_GET_BUILD_INFO,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urKernelCreate(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_KERNEL_CREATE, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urKernelGetGroupInfo(
  ...
  context.notify_end(UR_FUNCTION_KERNEL_GET_GROUP_INFO, "urKernelGetGroupInfo",
                     &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urKernelRetain(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_KERNEL_RETAIN, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urKernelSetArgPointer(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_KERNEL_SET_ARG_POINTER,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urKernelSetArgSampler(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_KERNEL_SET_ARG_SAMPLER,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urKernelSetArgMemObj(
  ...
  context.notify_end(UR_FUNCTION_KERNEL_SET_ARG_MEM_OBJ, "urKernelSetArgMemObj",
                     &params, &result, instance);

  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_KERNEL_SET_ARG_MEM_OBJ,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urKernelGetNativeHandle(
  ...
  uint64_t instance = context.notify_begin(UR_FUNCTION_KERNEL_GET_NATIVE_HANDLE,
...
__urdlllocal ur_result_t UR_APICALL urKernelCreateWithNativeHandle(
    ...
    /// [in] handle of the context object
    ur_context_handle_t hContext,
    /// [in] handle of the program associated with the kernel
    ur_program_handle_t hProgram,
...
__urdlllocal ur_result_t UR_APICALL urQueueCreate(
  ...
  ur_queue_create_params_t params = {&hContext, &hDevice, &pProperties,
                                     &phQueue};
  uint64_t instance =
      context.notify_begin(UR_FUNCTION_QUEUE_CREATE, "urQueueCreate", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_QUEUE_CREATE, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urQueueRetain(
  ...
  uint64_t instance =
      context.notify_begin(UR_FUNCTION_QUEUE_RETAIN, "urQueueRetain", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_QUEUE_RETAIN, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urQueueRelease(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_QUEUE_RELEASE, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urQueueGetNativeHandle(
  ...
  ur_queue_get_native_handle_params_t params = {&hQueue, &pDesc,
                                                &phNativeQueue};
  uint64_t instance = context.notify_begin(UR_FUNCTION_QUEUE_GET_NATIVE_HANDLE,
                                           "urQueueGetNativeHandle", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_QUEUE_GET_NATIVE_HANDLE,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urQueueFinish(
  ...
  uint64_t instance =
      context.notify_begin(UR_FUNCTION_QUEUE_FINISH, "urQueueFinish", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_QUEUE_FINISH, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urQueueFlush(
  ...
  context.notify_end(UR_FUNCTION_QUEUE_FLUSH, "urQueueFlush", &params, &result,
                     instance);
...
__urdlllocal ur_result_t UR_APICALL urEventGetProfilingInfo(
  ...
  ur_event_get_profiling_info_params_t params = {&hEvent, &propName, &propSize,
                                                 &pPropValue, &pPropSizeRet};
  uint64_t instance = context.notify_begin(UR_FUNCTION_EVENT_GET_PROFILING_INFO,
...
__urdlllocal ur_result_t UR_APICALL urEventRetain(
  ...
  uint64_t instance =
      context.notify_begin(UR_FUNCTION_EVENT_RETAIN, "urEventRetain", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_EVENT_RETAIN, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEventRelease(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_EVENT_RELEASE, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEventGetNativeHandle(
  ...
  uint64_t instance = context.notify_begin(UR_FUNCTION_EVENT_GET_NATIVE_HANDLE,
                                           "urEventGetNativeHandle", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_EVENT_GET_NATIVE_HANDLE,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueKernelLaunch(
  ...
  context.notify_end(UR_FUNCTION_ENQUEUE_KERNEL_LAUNCH, "urEnqueueKernelLaunch",
                     &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemBufferRead(
  ...
  ur_enqueue_mem_buffer_read_params_t params = {
      ...
      &phEvent};
  uint64_t instance = context.notify_begin(UR_FUNCTION_ENQUEUE_MEM_BUFFER_READ,
                                           "urEnqueueMemBufferRead", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ENQUEUE_MEM_BUFFER_READ,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemBufferWrite(
  ...
  ur_enqueue_mem_buffer_write_params_t params = {
      ...
      &phEvent};
  uint64_t instance = context.notify_begin(UR_FUNCTION_ENQUEUE_MEM_BUFFER_WRITE,
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemBufferReadRect(
  ...
  context.notify_end(UR_FUNCTION_ENQUEUE_MEM_BUFFER_READ_RECT,
                     "urEnqueueMemBufferReadRect", &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemBufferWriteRect(
  ...
  context.notify_end(UR_FUNCTION_ENQUEUE_MEM_BUFFER_WRITE_RECT,
                     "urEnqueueMemBufferWriteRect", &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemBufferCopy(
  ...
  uint64_t instance = context.notify_begin(UR_FUNCTION_ENQUEUE_MEM_BUFFER_COPY,
                                           "urEnqueueMemBufferCopy", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ENQUEUE_MEM_BUFFER_COPY,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemBufferCopyRect(
  ...
  context.notify_end(UR_FUNCTION_ENQUEUE_MEM_BUFFER_COPY_RECT,
                     "urEnqueueMemBufferCopyRect", &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemBufferFill(
  ...
  ur_enqueue_mem_buffer_fill_params_t params = {&hQueue,
                                                ...
                                                &phEventWaitList,
                                                &phEvent};
  uint64_t instance = context.notify_begin(UR_FUNCTION_ENQUEUE_MEM_BUFFER_FILL,
                                           "urEnqueueMemBufferFill", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ENQUEUE_MEM_BUFFER_FILL,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemImageRead(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ENQUEUE_MEM_IMAGE_READ,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemImageWrite(
  ...
  ur_enqueue_mem_image_write_params_t params = {
      ...
      &phEventWaitList, &phEvent};
  uint64_t instance = context.notify_begin(UR_FUNCTION_ENQUEUE_MEM_IMAGE_WRITE,
                                           "urEnqueueMemImageWrite", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ENQUEUE_MEM_IMAGE_WRITE,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemImageCopy(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ENQUEUE_MEM_IMAGE_COPY,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueMemBufferMap(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ENQUEUE_MEM_BUFFER_MAP,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueUSMFill(
  ...
  context.notify_end(UR_FUNCTION_ENQUEUE_USM_FILL, "urEnqueueUSMFill", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueUSMMemcpy2D(
  ...
  context.notify_end(UR_FUNCTION_ENQUEUE_USM_MEMCPY_2D, "urEnqueueUSMMemcpy2D",
                     &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueReadHostPipe(
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ENQUEUE_READ_HOST_PIPE,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueWriteHostPipe(
  ...
  ur_enqueue_write_host_pipe_params_t params = {
      ...
      &phEvent};
  uint64_t instance = context.notify_begin(UR_FUNCTION_ENQUEUE_WRITE_HOST_PIPE,
                                           "urEnqueueWriteHostPipe", &params);
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(args_str, UR_FUNCTION_ENQUEUE_WRITE_HOST_PIPE,
                                  &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urUSMPitchedAllocExp(
  ...
  context.notify_end(UR_FUNCTION_USM_PITCHED_ALLOC_EXP, "urUSMPitchedAllocExp",
                     &params, &result, instance);
...
urBindlessImagesUnsampledImageHandleDestroyExp(
    ...
    /// [in] handle of the device object
    ur_device_handle_t hDevice,
    /// [in] pointer to handle of image object to destroy
  ...
  std::ostringstream args_str;
  ur::extras::printFunctionParams(
      args_str, UR_FUNCTION_BINDLESS_IMAGES_UNSAMPLED_IMAGE_HANDLE_DESTROY_EXP,
      &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesImageFreeExp(
    ...
    /// [in] handle of the device object
    ur_device_handle_t hDevice,
    /// [in] handle of image memory to be freed
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesSampledImageCreateExp(
  ...
  uint64_t instance =
      context.notify_begin(UR_FUNCTION_BINDLESS_IMAGES_SAMPLED_IMAGE_CREATE_EXP,
  ...
  context.notify_end(UR_FUNCTION_BINDLESS_IMAGES_SAMPLED_IMAGE_CREATE_EXP,
                     "urBindlessImagesSampledImageCreateExp", &params, &result,
                     instance);

  std::ostringstream args_str;
  ur::extras::printFunctionParams(
      args_str, UR_FUNCTION_BINDLESS_IMAGES_SAMPLED_IMAGE_CREATE_EXP, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesImageCopyExp(
    ...
    /// [in] defines the (x,y,z) source offset in pixels in the 1D, 2D, or 3D
    /// image
    ur_rect_offset_t srcOffset,
    /// [in] defines the (x,y,z) destination offset in pixels in the 1D, 2D,
    /// or 3D image
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesMipmapFreeExp(
  ...
  auto pfnMipmapFreeExp = context.urDdiTable.BindlessImagesExp.pfnMipmapFreeExp;
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesImportExternalMemoryExp(
    ...
    /// [in] the interop memory descriptor
    ur_exp_interop_mem_desc_t *pInteropMemDesc,
    /// [out] interop memory handle to the external memory
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesMapExternalArrayExp(
    ...
    /// [in] pointer to image description
    const ur_image_desc_t *pImageDesc,
    /// [in] interop memory handle to the external memory
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesReleaseInteropExp(
    ...
    /// [in] handle of the device object
    ur_device_handle_t hDevice,
    /// [in] handle of interop memory to be freed
    ur_exp_interop_mem_handle_t hInteropMem) {
  ...
  ur_bindless_images_release_interop_exp_params_t params = {&hContext, &hDevice,
                                                            &hInteropMem};
  uint64_t instance =
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesImportExternalSemaphoreExp(
    ...
    /// [in] the interop semaphore descriptor
    ur_exp_interop_semaphore_desc_t *pInteropSemaphoreDesc,
    /// [out] interop semaphore handle to the external semaphore
  ...
  ur_result_t result =
      pfnImportExternalSemaphoreExp(hContext, hDevice, semHandleType,
                                    pInteropSemaphoreDesc, phInteropSemaphore);

  context.notify_end(UR_FUNCTION_BINDLESS_IMAGES_IMPORT_EXTERNAL_SEMAPHORE_EXP,
                     "urBindlessImagesImportExternalSemaphoreExp", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesDestroyExternalSemaphoreExp(
    ...
    /// [in] handle of the device object
    ur_device_handle_t hDevice,
    /// [in] handle of interop semaphore to be destroyed
  ...
  context.notify_end(UR_FUNCTION_BINDLESS_IMAGES_DESTROY_EXTERNAL_SEMAPHORE_EXP,
                     "urBindlessImagesDestroyExternalSemaphoreExp", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesWaitExternalSemaphoreExp(
    /// [in] handle of the queue object
    ur_queue_handle_t hQueue,
    /// [in] interop semaphore handle
    ur_exp_interop_semaphore_handle_t hSemaphore,
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesSignalExternalSemaphoreExp(
  ...
  context.notify_end(UR_FUNCTION_BINDLESS_IMAGES_SIGNAL_EXTERNAL_SEMAPHORE_EXP,
                     "urBindlessImagesSignalExternalSemaphoreExp", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferFinalizeExp(
  ...
  context.notify_end(UR_FUNCTION_COMMAND_BUFFER_FINALIZE_EXP,
                     "urCommandBufferFinalizeExp", &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferAppendKernelLaunchExp(
    ...
    const size_t *pGlobalWorkSize,
    /// [in][optional] Local work size to use when executing kernel.
    const size_t *pLocalWorkSize,
  ...
  ur_command_buffer_append_kernel_launch_exp_params_t params = {
      ...
      &phCommand};
  uint64_t instance =
      context.notify_begin(UR_FUNCTION_COMMAND_BUFFER_APPEND_KERNEL_LAUNCH_EXP,
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferAppendMemBufferCopyExp(
  ...
  context.notify_end(UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_EXP,
                     "urCommandBufferAppendMemBufferCopyExp", &params, &result,
                     instance);

  std::ostringstream args_str;
  ur::extras::printFunctionParams(
      args_str, UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_EXP, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferAppendMemBufferWriteExp(
  ...
  context.notify_end(UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_WRITE_EXP,
                     "urCommandBufferAppendMemBufferWriteExp", &params, &result,
                     instance);
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferAppendMemBufferReadExp(
  ...
  context.notify_end(UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_EXP,
                     "urCommandBufferAppendMemBufferReadExp", &params, &result,
                     instance);

  std::ostringstream args_str;
  ur::extras::printFunctionParams(
      args_str, UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_EXP, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferAppendMemBufferCopyRectExp(
  ...
  context.notify_end(UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_RECT_EXP,
                     "urCommandBufferAppendMemBufferCopyRectExp", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferAppendMemBufferReadRectExp(
  ...
  context.notify_end(UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_RECT_EXP,
                     "urCommandBufferAppendMemBufferReadRectExp", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferAppendMemBufferFillExp(
  ...
  context.notify_end(UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_FILL_EXP,
                     "urCommandBufferAppendMemBufferFillExp", &params, &result,
                     instance);

  std::ostringstream args_str;
  ur::extras::printFunctionParams(
      args_str, UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_FILL_EXP, &params);
  context.logger.info("({}) -> {};\n", args_str.str(), result);
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferAppendUSMPrefetchExp(
  ...
  ur_result_t result = pfnAppendUSMPrefetchExp(hCommandBuffer, pMemory, size,
                                               flags, numSyncPointsInWaitList,
                                               pSyncPointWaitList, pSyncPoint);
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferRetainCommandExp(
    /// [in] Handle of the command-buffer command.
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferUpdateKernelLaunchExp(
  ...
  uint64_t instance =
      context.notify_begin(UR_FUNCTION_COMMAND_BUFFER_UPDATE_KERNEL_LAUNCH_EXP,
...
__urdlllocal ur_result_t UR_APICALL urKernelSuggestMaxCooperativeGroupCountExp(
    /// [in] handle of the kernel object
    ur_kernel_handle_t hKernel,
    /// [in] number of local work-items that will form a work-group when the
    /// kernel is launched
  ...
  context.notify_end(UR_FUNCTION_KERNEL_SUGGEST_MAX_COOPERATIVE_GROUP_COUNT_EXP,
                     "urKernelSuggestMaxCooperativeGroupCountExp", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urProgramLinkExp(
  ...
  context.notify_end(UR_FUNCTION_PROGRAM_LINK_EXP, "urProgramLinkExp", &params,
                     &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urUsmP2PEnablePeerAccessExp(
  ...
  context.notify_end(UR_FUNCTION_USM_P2P_ENABLE_PEER_ACCESS_EXP,
                     "urUsmP2PEnablePeerAccessExp", &params, &result, instance);
...
__urdlllocal ur_result_t UR_APICALL urEnqueueNativeCommandExp(
    ...
    ur_event_handle_t *phEvent) {
  auto pfnNativeCommandExp = context.urDdiTable.EnqueueExp.pfnNativeCommandExp;
