      ...
      try {
        for (uint32_t i = 0; i < library_platform_handle_count; ++i) {
          ...
          phPlatforms[platform_index] = reinterpret_cast<ur_platform_handle_t>(
              ur_platform_factory.getInstance(phPlatforms[platform_index],
                                              dditable));
        }
      } catch (std::bad_alloc &) {
        result = UR_RESULT_ERROR_OUT_OF_HOST_MEMORY;
        ...
        for (size_t i = 0; i < nelements; ++i) {
          if (handles[i] != nullptr) {
            handles[i] = reinterpret_cast<ur_platform_handle_t>(
                ur_platform_factory.getInstance(handles[i], dditable));
          }
        }
      } break;
        ...
        for (size_t i = 0; i < nelements; ++i) {
          if (handles[i] != nullptr) {
            handles[i] = reinterpret_cast<ur_device_handle_t>(
                ur_device_factory.getInstance(handles[i], dditable));
          }
        }
      } break;
...
__urdlllocal ur_result_t UR_APICALL urContextCreateWithNativeHandle(
  ...
  // forward to device-platform
  result =
      pfnCreateWithNativeHandle(hNativeContext, numDevices,
        ...
        for (size_t i = 0; i < nelements; ++i) {
          if (handles[i] != nullptr) {
            handles[i] = reinterpret_cast<ur_context_handle_t>(
                ur_context_factory.getInstance(handles[i], dditable));
          }
        }
      } break;
      default: {
        ...
        for (size_t i = 0; i < nelements; ++i) {
          if (handles[i] != nullptr) {
            handles[i] = reinterpret_cast<ur_usm_pool_handle_t>(
                ur_usm_pool_factory.getInstance(handles[i], dditable));
          }
        }
      } break;
      default: {
        ...
        for (size_t i = 0; i < nelements; ++i) {
          if (handles[i] != nullptr) {
            handles[i] = reinterpret_cast<ur_program_handle_t>(
                ur_program_factory.getInstance(handles[i], dditable));
          }
        }
      } break;
      default: {
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesImageFreeExp(
  ...
  // convert loader handle to platform handle
  hImageMem = reinterpret_cast<ur_exp_image_mem_object_t *>(hImageMem)->handle;
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesImportExternalSemaphoreExp(
  ...
  try {
    // convert platform handle to loader handle
    *phInteropSemaphore = reinterpret_cast<ur_exp_interop_semaphore_handle_t>(
        ur_exp_interop_semaphore_factory.getInstance(*phInteropSemaphore,
                                                     dditable));
  } catch (std::bad_alloc &) {
    result = UR_RESULT_ERROR_OUT_OF_HOST_MEMORY;
  }
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesDestroyExternalSemaphoreExp(
  ...
  // forward to device-platform
  result = pfnDestroyExternalSemaphoreExp(hContext, hDevice, hInteropSemaphore);
...
__urdlllocal ur_result_t UR_APICALL urBindlessImagesWaitExternalSemaphoreExp(
  ...
  // convert loader handle to platform handle
  hSemaphore =
      reinterpret_cast<ur_exp_interop_semaphore_object_t *>(hSemaphore)->handle;
...
__urdlllocal ur_result_t UR_APICALL urCommandBufferCreateExp(
  ...
  try {
    ...
    *phCommandBuffer = reinterpret_cast<ur_exp_command_buffer_handle_t>(
        ur_exp_command_buffer_factory.getInstance(*phCommandBuffer, dditable));
  } catch (std::bad_alloc &) {
    result = UR_RESULT_ERROR_OUT_OF_HOST_MEMORY;
  }
  ...
  try {
    ...
    if (nullptr != phCommand)
      *phCommand = reinterpret_cast<ur_exp_command_buffer_command_handle_t>(
          ur_exp_command_buffer_command_factory.getInstance(*phCommand,
                                                            dditable));
  } catch (std::bad_alloc &) {
    result = UR_RESULT_ERROR_OUT_OF_HOST_MEMORY;
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetGlobalProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Global;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetBindlessImagesExpProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable =
          ur_loader::context->platforms.front().dditable.ur.BindlessImagesExp;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetCommandBufferExpProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable =
          ur_loader::context->platforms.front().dditable.ur.CommandBufferExp;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetContextProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Context;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetEnqueueProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Enqueue;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetEnqueueExpProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.EnqueueExp;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetEventProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Event;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetKernelProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Kernel;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetKernelExpProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.KernelExp;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetPlatformProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Platform;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetProgramProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Program;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetProgramExpProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.ProgramExp;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetQueueProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Queue;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetSamplerProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Sampler;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetUSMExpProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.USMExp;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetUsmP2PExpProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.UsmP2PExp;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetVirtualMemProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.VirtualMem;
    }
  }
...
UR_DLLEXPORT ur_result_t UR_APICALL urGetDeviceProcAddrTable(
  ...
  if (UR_RESULT_SUCCESS == result) {
    if (ur_loader::context->platforms.size() != 1 ||
      ...
      // return pointers directly to platform's DDIs
      *pDdiTable = ur_loader::context->platforms.front().dditable.ur.Device;
    }
  }
