...
__urdlllocal ur_result_t UR_APICALL urProgramBuild(
    ...
    if (nullptr != pfnBuild) {
        result = pfnBuild(hProgram, numDevices, phDevices, pOptions);
    } else {
        // generic implementation
    }
...
__urdlllocal ur_result_t UR_APICALL urProgramCompile(
    ...
    if (nullptr != pfnCompile) {
        result = pfnCompile(hProgram, numDevices, phDevices, pOptions);
    } else {
        // generic implementation
    }
...
__urdlllocal ur_result_t UR_APICALL urProgramLink(
    ...
    if (nullptr != pfnLink) {
        result = pfnLink(hContext, numDevices, phDevices, count, phPrograms,
                         pOptions, phProgram);
    } else {
        // generic implementation
        *phProgram = reinterpret_cast<ur_program_handle_t>(d_context.get());
