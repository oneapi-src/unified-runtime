...
typedef struct usm_umf_pool_tag_t {
...
struct ur_usm_pool_handle_t_ : _ur_object {
  ...
  // Tie the tags lifetime to the lifetime of ur_usm_pool_handle_t_.
  // std::list<> guarantees address stability for the pool tags.
  std::list<usm_umf_pool_tag_t> UmfPoolTags;
