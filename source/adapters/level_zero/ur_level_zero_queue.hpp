...
struct ur_queue_handle_t_ : _ur_object {
    ...
    struct pi_queue_group_t {
        ...
        uint32_t getQueueIndex(uint32_t *QueueGroupOrdinal,
                               uint32_t *QueueIndex, bool QueryOnly = false);
    ...
    struct pi_queue_group_by_tid_t
        ...
        void set(const pi_queue_group_t &QueueGroup) {
            ...
            PerThread = Device->ImmCommandListUsed ==
                        ur_device_handle_t_::PerThreadPerQueue;
            assert(empty());
        ...
        pi_queue_group_t &get() {
            ...
            QueueGroup.ImmCmdLists = std::vector<ur_command_list_ptr_t>(
                ...
                QueueGroup.Queue->CommandListMap.end());
    ...
    ur_result_t
        signalEventFromCmdListIfLastEventDiscarded(ur_command_list_ptr_t);
