...
ur_result_t urProgramBuild(
  ...
  return ur::level_zero::urProgramBuildExp(Program, Context->Devices.size(),
...
ur_result_t urProgramLink(
  ...
  return ur::level_zero::urProgramLinkExp(Context, Context->Devices.size(),
                                          Context->Devices.data(), Count,
