...
inline std::ostream &operator<<(std::ostream &os, [[maybe_unused]] const struct ur_exp_image_copy_subresource_t params);
...
inline std::ostream &operator<<(std::ostream &os, enum ur_structure_type_t value) {
    ...
    case UR_STRUCTURE_TYPE_EXP_IMAGE_COPY_REGION:
        ...
        break;
    case UR_STRUCTURE_TYPE_EXP_IMAGE_COPY_SUBRESOURCE:
        os << "UR_STRUCTURE_TYPE_EXP_IMAGE_COPY_SUBRESOURCE";
        break;
...
inline ur_result_t printStruct(std::ostream &os, const void *ptr) {
    ...
    case UR_STRUCTURE_TYPE_EXP_IMAGE_COPY_SUBRESOURCE: {
        const ur_exp_image_copy_subresource_t *pstruct = (const ur_exp_image_copy_subresource_t *)ptr;
        printPtr(os, pstruct);
    } break;
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print operator for the ur_exp_image_copy_subresource_t type
/// @returns
///     std::ostream &
inline std::ostream &operator<<(std::ostream &os, const struct ur_exp_image_copy_subresource_t params) {
    os << "(struct ur_exp_image_copy_subresource_t){";
    ...
    os << (params.baseArrayLayer);

    os << ", ";
    os << ".layerCount = ";

    os << (params.layerCount);
