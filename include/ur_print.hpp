...
inline std::ostream &operator<<(
  ...
  for (size_t i = 0;
       (params.pNewMemObjArgList) != NULL && i < params.numNewMemObjArgs; ++i) {
    if (i != 0) {
      os << ", ";
    }
  ...
  for (size_t i = 0;
       (params.pNewPointerArgList) != NULL && i < params.numNewPointerArgs;
       ++i) {
    if (i != 0) {
      os << ", ";
    }
  ...
  os << ".pNewValueArgList = {";
  for (size_t i = 0;
       (params.pNewValueArgList) != NULL && i < params.numNewValueArgs; ++i) {
    if (i != 0) {
      os << ", ";
    }
  ...
  for (size_t i = 0;
       (params.pNewGlobalWorkOffset) != NULL && i < params.newWorkDim; ++i) {
    if (i != 0) {
      os << ", ";
    }
  ...
  for (size_t i = 0;
       (params.pNewGlobalWorkSize) != NULL && i < params.newWorkDim; ++i) {
    if (i != 0) {
      os << ", ";
    }
  ...
  for (size_t i = 0;
       (params.pNewLocalWorkSize) != NULL && i < params.newWorkDim; ++i) {
    if (i != 0) {
      os << ", ";
    }
...
inline std::ostream &operator<<(
  ...
  ur::details::printPtr(os, *(params->phNativePlatform));
...
operator<<(std::ostream &os,
  ...
  os << ", ";
  os << ".phDevices = {";
  for (size_t i = 0; *(params->pphDevices) != NULL && i < *params->pDeviceCount;
       ++i) {
    if (i != 0) {
      os << ", ";
    }
...
inline std::ostream &operator<<(
  ...
  ur::details::printPtr(os, *(params->phNativeContext));
  ...
  os << ", ";
  os << ".phDevices = {";
  for (size_t i = 0; *(params->pphDevices) != NULL && i < *params->pnumDevices;
       ++i) {
    if (i != 0) {
      os << ", ";
    }
...
inline std::ostream &operator<<(
  ...
  ur::details::printPtr(os, *(params->phNativeEvent));
...
operator<<(std::ostream &os,
  ...
  ur::details::printPtr(os, *(params->ppBinary));
...
operator<<(std::ostream &os, [[maybe_unused]] const struct
  ...
  os << ", ";
  os << ".pSpecConstants = {";
  for (size_t i = 0; *(params->ppSpecConstants) != NULL && i < *params->pcount;
       ++i) {
    if (i != 0) {
      os << ", ";
    }
...
inline std::ostream &operator<<(
  ...
  ur::details::printPtr(os, *(params->phNativeProgram));
...
inline std::ostream &operator<<(
  ...
  ur::details::printPtr(os, *(params->phNativeKernel));
...
inline std::ostream &operator<<(
  ...
  ur::details::printPtr(os, *(params->phNativeQueue));
...
inline std::ostream &operator<<(
  ...
  ur::details::printPtr(os, *(params->phNativeSampler));
...
operator<<(std::ostream &os, [[maybe_unused]] const struct
  ...
  ur::details::printPtr(os, *(params->phNativeMem));
...
operator<<(std::ostream &os,
  ...
  os << ", ";
  os << ".phAdapters = {";
  for (size_t i = 0; *(params->pphAdapters) != NULL && i < *params->pNumEntries;
       ++i) {
    if (i != 0) {
      os << ", ";
    }
...
inline std::ostream &operator<<(
  ...
  os << ".phEventWaitList = {";
  for (size_t i = 0;
       *(params->pphEventWaitList) != NULL && i < *params->pnumEventsInWaitList;
       ++i) {
    if (i != 0) {
      os << ", ";
    }
...
inline std::ostream &operator<<(
  ...
  os << ", ";
  os << ".launchPropList = {";
  for (size_t i = 0; *(params->plaunchPropList) != NULL &&
                     i < *params->pnumPropsInLaunchPropList;
       ++i) {
    if (i != 0) {
      os << ", ";
    }
...
inline std::ostream &operator<<(
  ...
  ur::details::printPtr(os, *(params->phImageMem));
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print operator for the
/// ur_bindless_images_import_opaque_fd_exp_params_t type
/// @returns
///     std::ostream &
inline std::ostream &
operator<<(std::ostream &os, [[maybe_unused]] const struct
  ...
  ur::details::printPtr(os, *(params->ppInteropMemDesc));

  os << ", ";
  os << ".phInteropMem = ";

  ur::details::printPtr(os, *(params->pphInteropMem));
...
operator<<(std::ostream &os, [[maybe_unused]] const struct
  ...
  ur::details::printPtr(os, *(params->phInteropMem));
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print operator for the
/// ur_bindless_images_release_interop_exp_params_t type
/// @returns
///     std::ostream &
inline std::ostream &
operator<<(std::ostream &os, [[maybe_unused]] const struct
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print operator for the
/// ur_bindless_images_import_external_semaphore_opaque_fd_exp_params_t type
/// @returns
///     std::ostream &
inline std::ostream &
operator<<(std::ostream &os, [[maybe_unused]] const struct
  ...
  ur::details::printPtr(os, *(params->ppInteropSemaphoreDesc));

  os << ", ";
  os << ".phInteropSemaphore = ";

  ur::details::printPtr(os, *(params->pphInteropSemaphore));
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print operator for the
/// ur_bindless_images_destroy_external_semaphore_exp_params_t type
/// @returns
///     std::ostream &
inline std::ostream &
operator<<(std::ostream &os, [[maybe_unused]] const struct
  ...
  ur::details::printPtr(os, *(params->phInteropSemaphore));
...
operator<<(std::ostream &os,
  ...
  os << ", ";
  os << ".phDevices = {";
  for (size_t i = 0; *(params->pphDevices) != NULL && i < *params->pNumEntries;
       ++i) {
    if (i != 0) {
      os << ", ";
    }
...
inline std::ostream &operator<<(
  ...
  ur::details::printPtr(os, *(params->phNativeDevice));
