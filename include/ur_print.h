...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_exp_image_copy_subresource_t struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintExpImageCopySubresource(const struct ur_exp_image_copy_subresource_t params, char *buffer, const size_t buff_size, size_t *out_size);
