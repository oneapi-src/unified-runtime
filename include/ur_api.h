...
typedef enum ur_function_t {
    ...
    UR_FUNCTION_TENSOR_MAP_ENCODE_IM_2_COL_EXP = 246,                     ///< Enumerator for ::urTensorMapEncodeIm2ColExp
    UR_FUNCTION_TENSOR_MAP_ENCODE_TILED_EXP = 247,                        ///< Enumerator for ::urTensorMapEncodeTiledExp
    /// @cond
