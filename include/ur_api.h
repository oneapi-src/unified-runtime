...
typedef enum ur_function_t {
    ...
    UR_FUNCTION_ENQUEUE_USM_DEVICE_ALLOC_EXP = 249,                       ///< Enumerator for ::urEnqueueUSMDeviceAllocExp
    UR_FUNCTION_ENQUEUE_USM_SHARED_ALLOC_EXP = 250,                       ///< Enumerator for ::urEnqueueUSMSharedAllocExp
    UR_FUNCTION_ENQUEUE_USM_HOST_ALLOC_EXP = 251,                         ///< Enumerator for ::urEnqueueUSMHostAllocExp
    UR_FUNCTION_ENQUEUE_USM_FREE_EXP = 252,                               ///< Enumerator for ::urEnqueueUSMFreeExp
    /// @cond
...
typedef enum ur_device_info_t {
    ...
    UR_DEVICE_INFO_ENQUEUE_USM_ALLOCATIONS_EXP = 0x2023,             ///< [::ur_bool_t] returns true if the device supports USM allocation
                                                                     ///< enqueueing
    /// @cond
