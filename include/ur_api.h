...
typedef enum ur_function_t {
    ...
    UR_FUNCTION_ENQUEUE_USM_MEMSET = 34,
    UR_FUNCTION_ENQUEUE_USM_MEMCPY = 35,
    UR_FUNCTION_ENQUEUE_USM_PREFETCH = 36,
    UR_FUNCTION_ENQUEUE_USM_MEM_ADVISE = 37,
    UR_FUNCTION_ENQUEUE_USM_FILL2_D = 38,
    UR_FUNCTION_ENQUEUE_USM_MEMSET2_D = 39,
    UR_FUNCTION_ENQUEUE_USM_MEMCPY2_D = 40,
    UR_FUNCTION_ENQUEUE_DEVICE_GLOBAL_VARIABLE_WRITE = 41,
    UR_FUNCTION_ENQUEUE_DEVICE_GLOBAL_VARIABLE_READ = 42,
    UR_FUNCTION_EVENT_GET_INFO = 43,
    UR_FUNCTION_EVENT_GET_PROFILING_INFO = 44,
    UR_FUNCTION_EVENT_WAIT = 45,
    UR_FUNCTION_EVENT_RETAIN = 46,
    UR_FUNCTION_EVENT_RELEASE = 47,
    UR_FUNCTION_EVENT_GET_NATIVE_HANDLE = 48,
    UR_FUNCTION_EVENT_CREATE_WITH_NATIVE_HANDLE = 49,
    UR_FUNCTION_EVENT_SET_CALLBACK = 50,
    UR_FUNCTION_KERNEL_CREATE = 51,
    UR_FUNCTION_KERNEL_SET_ARG_VALUE = 52,
    UR_FUNCTION_KERNEL_SET_ARG_LOCAL = 53,
    UR_FUNCTION_KERNEL_GET_INFO = 54,
    UR_FUNCTION_KERNEL_GET_GROUP_INFO = 55,
    UR_FUNCTION_KERNEL_GET_SUB_GROUP_INFO = 56,
    UR_FUNCTION_KERNEL_RETAIN = 57,
    UR_FUNCTION_KERNEL_RELEASE = 58,
    UR_FUNCTION_KERNEL_SET_ARG_POINTER = 59,
    UR_FUNCTION_KERNEL_SET_EXEC_INFO = 60,
    UR_FUNCTION_KERNEL_SET_ARG_SAMPLER = 61,
    UR_FUNCTION_KERNEL_SET_ARG_MEM_OBJ = 62,
    UR_FUNCTION_KERNEL_GET_NATIVE_HANDLE = 63,
    UR_FUNCTION_KERNEL_CREATE_WITH_NATIVE_HANDLE = 64,
    UR_FUNCTION_MEM_IMAGE_CREATE = 65,
    UR_FUNCTION_MEM_BUFFER_CREATE = 66,
    UR_FUNCTION_MEM_RETAIN = 67,
    UR_FUNCTION_MEM_RELEASE = 68,
    UR_FUNCTION_MEM_BUFFER_PARTITION = 69,
    UR_FUNCTION_MEM_GET_NATIVE_HANDLE = 70,
    UR_FUNCTION_MEM_CREATE_WITH_NATIVE_HANDLE = 71,
    UR_FUNCTION_MEM_GET_INFO = 72,
    UR_FUNCTION_MEM_IMAGE_GET_INFO = 73,
    UR_FUNCTION_MODULE_CREATE = 74,
    UR_FUNCTION_MODULE_RETAIN = 75,
    UR_FUNCTION_MODULE_RELEASE = 76,
    UR_FUNCTION_MODULE_GET_NATIVE_HANDLE = 77,
    UR_FUNCTION_MODULE_CREATE_WITH_NATIVE_HANDLE = 78,
    UR_FUNCTION_PLATFORM_GET = 79,
    UR_FUNCTION_PLATFORM_GET_INFO = 80,
    UR_FUNCTION_PLATFORM_GET_API_VERSION = 81,
    UR_FUNCTION_PLATFORM_GET_NATIVE_HANDLE = 82,
    UR_FUNCTION_PLATFORM_CREATE_WITH_NATIVE_HANDLE = 83,
    UR_FUNCTION_GET_LAST_RESULT = 84,
    UR_FUNCTION_PROGRAM_CREATE = 85,
    UR_FUNCTION_PROGRAM_CREATE_WITH_BINARY = 86,
    UR_FUNCTION_PROGRAM_RETAIN = 87,
    UR_FUNCTION_PROGRAM_RELEASE = 88,
    UR_FUNCTION_PROGRAM_GET_FUNCTION_POINTER = 89,
    UR_FUNCTION_PROGRAM_GET_INFO = 90,
    UR_FUNCTION_PROGRAM_GET_BUILD_INFO = 91,
    UR_FUNCTION_PROGRAM_SET_SPECIALIZATION_CONSTANT = 92,
    UR_FUNCTION_PROGRAM_GET_NATIVE_HANDLE = 93,
    UR_FUNCTION_PROGRAM_CREATE_WITH_NATIVE_HANDLE = 94,
    UR_FUNCTION_QUEUE_GET_INFO = 95,
    UR_FUNCTION_QUEUE_CREATE = 96,
    UR_FUNCTION_QUEUE_RETAIN = 97,
    UR_FUNCTION_QUEUE_RELEASE = 98,
    UR_FUNCTION_QUEUE_GET_NATIVE_HANDLE = 99,
    UR_FUNCTION_QUEUE_CREATE_WITH_NATIVE_HANDLE = 100,
    UR_FUNCTION_QUEUE_FINISH = 101,
    UR_FUNCTION_QUEUE_FLUSH = 102,
    UR_FUNCTION_INIT = 103,
    UR_FUNCTION_TEAR_DOWN = 104,
    UR_FUNCTION_SAMPLER_CREATE = 105,
    UR_FUNCTION_SAMPLER_RETAIN = 106,
    UR_FUNCTION_SAMPLER_RELEASE = 107,
    UR_FUNCTION_SAMPLER_GET_INFO = 108,
    UR_FUNCTION_SAMPLER_GET_NATIVE_HANDLE = 109,
    UR_FUNCTION_SAMPLER_CREATE_WITH_NATIVE_HANDLE = 110,
    UR_FUNCTION_USM_HOST_ALLOC = 111,
    UR_FUNCTION_USM_DEVICE_ALLOC = 112,
    UR_FUNCTION_USM_SHARED_ALLOC = 113,
    UR_FUNCTION_USM_FREE = 114,
    UR_FUNCTION_USM_GET_MEM_ALLOC_INFO = 115,
    UR_FUNCTION_USM_POOL_CREATE = 116,
    UR_FUNCTION_USM_POOL_DESTROY = 117,
