...
typedef enum ur_function_t {
  ...
  UR_FUNCTION_COMMAND_BUFFER_ENQUEUE_EXP = 128,
  ...
  UR_FUNCTION_BINDLESS_IMAGES_IMPORT_OPAQUE_FD_EXP = 143,
  ...
  UR_FUNCTION_BINDLESS_IMAGES_RELEASE_INTEROP_EXP = 145,
  /// Enumerator for ::urBindlessImagesImportExternalSemaphoreOpaqueFDExp
  UR_FUNCTION_BINDLESS_IMAGES_IMPORT_EXTERNAL_SEMAPHORE_OPAQUE_FD_EXP = 146,
  /// Enumerator for ::urBindlessImagesDestroyExternalSemaphoreExp
  UR_FUNCTION_BINDLESS_IMAGES_DESTROY_EXTERNAL_SEMAPHORE_EXP = 147,
  ...
  UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_MEMCPY_EXP = 203,
  /// Enumerator for ::urCommandBufferAppendUSMFillExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_FILL_EXP = 204,
  /// Enumerator for ::urCommandBufferAppendMemBufferCopyExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_EXP = 205,
  /// Enumerator for ::urCommandBufferAppendMemBufferWriteExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_WRITE_EXP = 206,
  /// Enumerator for ::urCommandBufferAppendMemBufferReadExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_EXP = 207,
  /// Enumerator for ::urCommandBufferAppendMemBufferCopyRectExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_RECT_EXP = 208,
  /// Enumerator for ::urCommandBufferAppendMemBufferWriteRectExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_WRITE_RECT_EXP = 209,
  /// Enumerator for ::urCommandBufferAppendMemBufferReadRectExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_RECT_EXP = 210,
  /// Enumerator for ::urCommandBufferAppendMemBufferFillExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_FILL_EXP = 211,
  /// Enumerator for ::urCommandBufferAppendUSMPrefetchExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_PREFETCH_EXP = 212,
  /// Enumerator for ::urCommandBufferAppendUSMAdviseExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_ADVISE_EXP = 213,
...
typedef enum ur_structure_type_t {
  ...
  UR_STRUCTURE_TYPE_EXP_INTEROP_MEM_DESC = 0x2001,
  /// ::ur_exp_interop_semaphore_desc_t
  UR_STRUCTURE_TYPE_EXP_INTEROP_SEMAPHORE_DESC = 0x2002,
...
UR_APIEXPORT ur_result_t UR_APICALL urLoaderConfigRetain(
    /// [in] loader config handle to retain
...
typedef enum ur_api_version_t {
  ...
  UR_API_VERSION_CURRENT = UR_MAKE_VERSION(0, 10),
  /// @cond
...
///        specific
///        binary images. We need to map the image type onto the device target
///        triple
...
typedef enum ur_device_info_t {
  ...
  /// [uint32_t[]] return an array of sub group sizes supported on Intel
  /// device
  ...
  /// [uint32_t] return the width in bits of the memory bus interface of the
  /// device.
  ...
  /// [uint32_t] The device IP version. The meaning of the device IP version
  ...
  /// [::ur_device_handle_t[]] The set of component devices contained by
  /// this composite device.
  UR_DEVICE_INFO_COMPONENT_DEVICES = 116,
  /// [::ur_device_handle_t] The composite device containing this component
  /// device.
  ...
  /// [::ur_bool_t] Returns true if the device supports updating the kernel
  /// commands in a command-buffer.
  UR_DEVICE_INFO_COMMAND_BUFFER_UPDATE_SUPPORT_EXP = 0x1001,
  ...
  /// memory resources
  UR_DEVICE_INFO_INTEROP_MEMORY_IMPORT_SUPPORT_EXP = 0x200C,
  /// [::ur_bool_t] returns true if the device supports exporting internal
  /// memory resources
  UR_DEVICE_INFO_INTEROP_MEMORY_EXPORT_SUPPORT_EXP = 0x200D,
  /// [::ur_bool_t] returns true if the device supports importing external
  /// semaphore resources
  UR_DEVICE_INFO_INTEROP_SEMAPHORE_IMPORT_SUPPORT_EXP = 0x200E,
  /// [::ur_bool_t] returns true if the device supports exporting internal
  /// event resources
  UR_DEVICE_INFO_INTEROP_SEMAPHORE_EXPORT_SUPPORT_EXP = 0x200F,
  ...
  UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_3D_USM_EXP = 0x2016,
  /// [::ur_bool_t] returns true if the device is capable of fetching
...
typedef enum ur_mem_type_t {
  /// Buffer object
  UR_MEM_TYPE_BUFFER = 0,
  /// 2D image object
  UR_MEM_TYPE_IMAGE2D = 1,
  /// 3D image object
  UR_MEM_TYPE_IMAGE3D = 2,
  /// 2D image array object
  UR_MEM_TYPE_IMAGE2D_ARRAY = 3,
  /// 1D image object
  UR_MEM_TYPE_IMAGE1D = 4,
  /// 1D image array object
  UR_MEM_TYPE_IMAGE1D_ARRAY = 5,
  /// 1D image buffer object
  UR_MEM_TYPE_IMAGE1D_BUFFER = 6,
...
typedef enum ur_program_info_t {
  ...
  /// [char[]] Return a null-terminated, semi-colon separated list of kernel
  /// names in Program.
...
typedef enum ur_kernel_info_t {
  ...
  /// [uint32_t] Return the number of registers used by the compiled kernel
  /// (device specific).
...
typedef enum ur_queue_info_t {
  ...
  /// [::ur_bool_t] return true if the queue was empty at the time of the
  /// query
...
typedef enum ur_command_t {
  ...
  UR_COMMAND_INTEROP_SEMAPHORE_WAIT_EXP = 0x2000,
  /// Event created by ::urBindlessImagesSignalExternalSemaphoreExp
  UR_COMMAND_INTEROP_SEMAPHORE_SIGNAL_EXP = 0x2001,
...
typedef struct ur_exp_interop_semaphore_handle_t_
...
typedef struct ur_exp_command_buffer_update_memobj_arg_desc_t {
  ...
  /// [in] Argument index.
  uint32_t argIndex;
  /// [in][optinal] Pointer to memory object properties.
  const ur_kernel_arg_mem_obj_properties_t *pProperties;
...
typedef struct ur_exp_command_buffer_update_pointer_arg_desc_t {
  ...
  /// [in] Argument index.
  uint32_t argIndex;
  /// [in][optinal] Pointer to USM pointer properties.
  const ur_kernel_arg_pointer_properties_t *pProperties;
  /// [in][optional] USM pointer to memory location holding the argument
...
typedef struct ur_exp_command_buffer_update_value_arg_desc_t {
  ...
  /// [in] Argument size.
  uint32_t argSize;
  /// [in][optinal] Pointer to value properties.
  const ur_kernel_arg_value_properties_t *pProperties;
...
///     - ::UR_RESULT_ERROR_INVALID_DEVICE
///     - ::UR_RESULT_ERROR_INVALID_OPERATION
///         + If `pCommandBufferDesc->isUpdatable` is true and `hDevice` does
///         not support UR_DEVICE_INFO_COMMAND_BUFFER_UPDATE_SUPPORT_EXP.
///     - ::UR_RESULT_ERROR_OUT_OF_HOST_MEMORY
///     - ::UR_RESULT_ERROR_OUT_OF_RESOURCES
...
///         finalized.
///         + If `pUpdateKernellaunch->newWorkDim` is non-zero and different
///         from the work-dim used on creation of `hCommand`.
///         + If `pUpdateKernellaunch->newWorkDim` is non-zero and
///         `pUpdateKernelLaunch->pNewLocalWorkSize` is set to a non-NULL value
///         and `pUpdateKernelLaunch->pNewGlobalWorkSize` is NULL.
///         + If `pUpdateKernellaunch->newWorkDim` is non-zero and
///         `pUpdateKernelLaunch->pNewLocalWorkSize` is set to a non-NULL value
///         when `hCommand` was created with a NULL local work size.
///         + If `pUpdateKernellaunch->newWorkDim` is non-zero and
///         `pUpdateKernelLaunch->pNewLocalWorkSize` is set to a NULL value when
///         `hCommand` was created with a non-NULL local work size.
///     - ::UR_RESULT_ERROR_INVALID_COMMAND_BUFFER_COMMAND_HANDLE_EXP
///     - ::UR_RESULT_ERROR_INVALID_MEM_OBJECT
///     - ::UR_RESULT_ERROR_INVALID_KERNEL_ARGUMENT_INDEX
///     - ::UR_RESULT_ERROR_INVALID_KERNEL_ARGUMENT_SIZE
...
typedef enum ur_exp_peer_info_t {
  /// [uint32_t] 1 if P2P access is supported otherwise P2P access is not
  /// supported.
  UR_EXP_PEER_INFO_UR_PEER_ACCESS_SUPPORTED = 0,
  /// [uint32_t] 1 if atomic operations are supported over the P2P link,
