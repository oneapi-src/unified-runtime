...
typedef enum ur_device_info_t {
    ...
    UR_DEVICE_INFO_INTEROP_SEMAPHORE_EXPORT_SUPPORT_EXP = 0x200F,    ///< [::ur_bool_t] returns true if the device supports exporting internal
                                                                     ///< event resources
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_1D_USM_EXP = 0x2010, ///< [::ur_bool_t] returns true if the device is capable of fetching USM
                                                                     ///< backed 1D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_1D_EXP = 0x2011,     ///< [::ur_bool_t] returns true if the device is capable of fetching
                                                                     ///< non-USM backed 1D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_2D_USM_EXP = 0x2012, ///< [::ur_bool_t] returns true if the device is capable of fetching USM
                                                                     ///< backed 2D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_2D_EXP = 0x2013,     ///< [::ur_bool_t] returns true if the device is capable of fetching
                                                                     ///< non-USM backed 2D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_3D_USM_EXP = 0x2014, ///< [::ur_bool_t] returns true if the device is capable of fetching USM
                                                                     ///< backed 3D sampled image data.
    UR_DEVICE_INFO_BINDLESS_SAMPLED_IMAGE_FETCH_3D_EXP = 0x2015,     ///< [::ur_bool_t] returns true if the device is capable of fetching
