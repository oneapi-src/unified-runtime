...
typedef enum ur_structure_type_t {
    ...
    UR_STRUCTURE_TYPE_EXP_IMAGE_COPY_SUBRESOURCE = 0x2008,                   ///< ::ur_exp_image_copy_subresource_t
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Provides information required for copying to/from non-standard images
typedef struct ur_exp_image_copy_subresource_t {
    ur_structure_type_t stype; ///< [in] type of this structure, must be
                               ///< ::UR_STRUCTURE_TYPE_EXP_IMAGE_COPY_SUBRESOURCE
    const void *pNext;         ///< [in][optional] pointer to extension-specific structure
    uint32_t mipLevel;         ///< [in] the mipmap level to copy
    uint32_t baseArrayLayer;   ///< [in] the starting image layer to copy
    uint32_t layerCount;       ///< [in] number of layers to copy

} ur_exp_image_copy_subresource_t;
...
typedef struct ur_exp_image_copy_region_t {
    ...
    ur_exp_image_copy_subresource_t srcSubresource; ///< [in] Provides information required for copying from mipmaps, image
                                                    ///< arrays, cubemaps
    ur_rect_offset_t dstOffset;                     ///< [in] the offset into the destination image
    ur_exp_image_copy_subresource_t dstSubresource; ///< [in] Provides information required for copying to mipmaps, image
                                                    ///< arrays, cubemaps
