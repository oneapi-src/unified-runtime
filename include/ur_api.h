...
typedef enum ur_function_t {
    ...
    UR_FUNCTION_LOADER_CONFIG_SET_CALLBACK_LAYER_PROPERTIES = 225,             ///< Enumerator for ::urLoaderConfigSetCallbackLayerProperties
    /// @cond
...
typedef enum ur_structure_type_t {
    ...
    UR_STRUCTURE_TYPE_CALLBACK_PROPERTIES = 37,                              ///< ::ur_callback_properties_t
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Callback properties
typedef struct ur_callback_properties_t {
    ur_structure_type_t stype;        ///< [in] type of this structure, must be
                                      ///< ::UR_STRUCTURE_TYPE_CALLBACK_PROPERTIES
    void *pNext;                      ///< [in,out][optional] pointer to extension-specific structure
...
} ur_callback_properties_t;

///////////////////////////////////////////////////////////////////////////////
/// @brief Callback layer properties
///
/// @details
/// The pNext member of this struct can be used to chain multiple instances of ::ur_callback_properties_t, allowing multiple callback assignments at once.
typedef struct ur_callback_layer_properties_t {
    ur_structure_type_t stype; ///< [in] type of this structure, must be
                               ///< ::UR_STRUCTURE_TYPE_CALLBACK_LAYER_PROPERTIES
    void *pNext;               ///< [in,out][optional] pointer to extension-specific structure
    ur_bool_t enableMock;      ///< [in] With mocking enabled the layer will act as a mock adapter.
...
UR_APIEXPORT ur_result_t UR_APICALL
urLoaderConfigSetCallbackLayerProperties(
    ur_loader_config_handle_t hLoaderConfig,                 ///< [in] Handle to config object the layer will be enabled for.
    ur_callback_layer_properties_t *pCallbackLayerProperties ///< [in] Pointer to callback layer properties struct.
);
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Function parameters for urLoaderConfigSetCallbackLayerProperties
/// @details Each entry is a pointer to the parameter passed to the function;
///     allowing the callback the ability to modify the parameter's value
typedef struct ur_loader_config_set_callback_layer_properties_params_t {
    ur_loader_config_handle_t *phLoaderConfig;
    ur_callback_layer_properties_t **ppCallbackLayerProperties;
} ur_loader_config_set_callback_layer_properties_params_t;
