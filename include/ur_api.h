...
typedef enum ur_function_t {
    ...
    UR_FUNCTION_ENQUEUE_USM_DEVICE_ALLOC_EXP = 233,                       ///< Enumerator for ::urEnqueueUSMDeviceAllocExp
    UR_FUNCTION_ENQUEUE_USM_SHARED_ALLOC_EXP = 234,                       ///< Enumerator for ::urEnqueueUSMSharedAllocExp
    UR_FUNCTION_ENQUEUE_USM_HOST_ALLOC_EXP = 235,                         ///< Enumerator for ::urEnqueueUSMHostAllocExp
    UR_FUNCTION_ENQUEUE_USM_FREE_EXP = 236,                               ///< Enumerator for ::urEnqueueUSMFreeExp
    /// @cond
