...
typedef ur_result_t(UR_APICALL *ur_pfnPlatformCreateWithNativeHandle_t)(
    ur_native_handle_t, const ur_platform_native_properties_t *,
    ur_platform_handle_t *);
...
typedef ur_result_t(
    ...
    ur_kernel_handle_t, size_t, size_t, uint32_t *);
...
typedef ur_result_t(
    ...
    ur_context_handle_t, ur_device_handle_t, ur_exp_image_handle_t);
...
typedef ur_result_t(UR_APICALL *ur_pfnBindlessImagesImageCopyExp_t)(
    ur_queue_handle_t, void *, void *, const ur_image_format_t *,
    const ur_image_desc_t *, ur_exp_image_copy_flags_t, ur_rect_offset_t,
    ur_rect_offset_t, ur_rect_region_t, ur_rect_region_t, uint32_t,
    const ur_event_handle_t *, ur_event_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnBindlessImagesImageGetInfoExp_t)(
    ur_exp_image_mem_handle_t, ur_image_info_t, void *, size_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnBindlessImagesMipmapGetLevelExp_t)(
    ur_context_handle_t, ur_device_handle_t, ur_exp_image_mem_handle_t,
    uint32_t, ur_exp_image_mem_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnBindlessImagesImportOpaqueFDExp_t)(
    ur_context_handle_t, ur_device_handle_t, size_t,
    ur_exp_interop_mem_desc_t *, ur_exp_interop_mem_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnBindlessImagesMapExternalArrayExp_t)(
    ur_context_handle_t, ur_device_handle_t, const ur_image_format_t *,
    const ur_image_desc_t *, ur_exp_interop_mem_handle_t,
...
typedef ur_result_t(UR_APICALL *ur_pfnBindlessImagesReleaseInteropExp_t)(
    ur_context_handle_t, ur_device_handle_t, ur_exp_interop_mem_handle_t);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for
/// urBindlessImagesImportExternalSemaphoreOpaqueFDExp
typedef ur_result_t(
    UR_APICALL *ur_pfnBindlessImagesImportExternalSemaphoreOpaqueFDExp_t)(
    ur_context_handle_t, ur_device_handle_t, ur_exp_interop_semaphore_desc_t *,
    ur_exp_interop_semaphore_handle_t *);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urBindlessImagesDestroyExternalSemaphoreExp
typedef ur_result_t(
    UR_APICALL *ur_pfnBindlessImagesDestroyExternalSemaphoreExp_t)(
...
typedef ur_result_t(UR_APICALL *ur_pfnBindlessImagesWaitExternalSemaphoreExp_t)(
    ur_queue_handle_t, ur_exp_interop_semaphore_handle_t, uint32_t,
    const ur_event_handle_t *, ur_event_handle_t *);
...
typedef struct ur_bindless_images_exp_dditable_t {
  ...
  ur_pfnBindlessImagesDestroyExternalSemaphoreExp_t
